...
class SAPDAConfiguration:
    ...
    def update(self, new_config):
        ...
        If True is returned, a change was made to the configuration. If no change, False is returned.
        """
    ...
    def no_valid_transitions(self):
        """
        If at least one leaf in the configuration is in transition_dict, return False. Else, return True
        """
        for leaf in self.configuration.get_all_leaves():
            if leaf.get_dict_key() in self.transition_dict:
                return False
        return True
    ...
    def is_rejecting_config(self):
        ...
        return False
        #return self.no_valid_transitions()
    ...
    def run_machine(self):
        ...
        try:
            ...
            try:
                return SAPDAConfiguration(self.sapda, self.input_string).bfs()
    ...
    def backtrack(self, path, depth):
        ...
        last_self = SAPDAConfiguration(self.sapda, self.input_string, last_computation, last_config,
        ...
        while not paths.empty():
            ...
            for leaf in current_self.order_active_branches():
                ...
                for letter, conjuncts in current_self.order_transitions(leaf):
                    ...
                    if (not (accept or reject)) and (new_self.get_priority(), id(new_self), new_self) not in paths.queue and new_self.configuration.get_tree_depth() < 6:
...
# print(sapda4)
#sapda = SAPDAConfiguration(sapda3, 'abba$abba')
#sapda = SAPDAConfiguration(sapda4, '0000000000000000')
# # #
